...
function listOfferedCourses($conn) {
    try {
        ...
        $stmt = $conn->query("SELECT q.qualification_id, q.qualification_name, q.status, q.nc_level_id, nc.nc_level_code FROM tbl_qualifications q LEFT JOIN tbl_nc_levels nc ON q.nc_level_id = nc.nc_level_id ORDER BY q.qualification_name");
