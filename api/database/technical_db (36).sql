...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 17, 2026 at 02:45 PM
...
(22, 26, 'Senior High (K-12)', 'Unemployed', NULL, 'Student', 0, '', '', 1, 'sig_1771314550.png'),
(24, 28, 'Vocational Graduate', 'Unemployed', NULL, 'Student', 1, 'Physical Disability', 'Illness', 1, NULL),
(25, 29, 'High School Graduate', 'Unemployed', NULL, 'Worker', 0, NULL, NULL, 1, NULL),
(26, 30, 'Vocational Graduate', 'Self-Employed', NULL, 'Worker', 0, NULL, NULL, 1, NULL),
(27, 31, 'High School Graduate', 'Self-Employed', NULL, 'Out-of-School Youth', 0, NULL, NULL, 1, NULL),
(28, 32, 'Vocational Graduate', 'Wage-Employed', 'Contractual', 'Student', 0, NULL, NULL, 1, NULL),
(29, 33, 'Vocational Graduate', 'Self-Employed', NULL, 'Worker', 0, NULL, NULL, 1, NULL),
(30, 34, 'High School Graduate', 'Self-Employed', NULL, 'Worker', 0, NULL, NULL, 1, NULL),
(31, 35, 'College Graduate', 'Self-Employed', NULL, 'Student', 0, NULL, NULL, 1, NULL),
(32, 36, 'College Graduate', 'Self-Employed', NULL, 'Out-of-School Youth', 1, 'Physical Disability', 'Congenital', 1, NULL),
(33, 37, 'Elementary Graduate', 'Unemployed', NULL, 'Out-of-School Youth', 0, NULL, NULL, 1, NULL),
(34, 38, 'College Graduate', 'Unemployed', NULL, 'Worker', 0, NULL, NULL, 1, NULL),
(35, 39, 'College Graduate', 'Wage-Employed', 'Regular', 'Student', 0, NULL, NULL, 1, NULL),
(36, 40, 'Vocational Graduate', 'Unemployed', NULL, 'Out-of-School Youth', 0, NULL, NULL, 1, NULL),
(37, 41, 'College Level', 'Unemployed', NULL, 'Out-of-School Youth', 0, NULL, NULL, 1, NULL),
(38, 42, 'College Level', 'Self-Employed', NULL, 'Out-of-School Youth', 0, NULL, NULL, 1, NULL),
(39, 43, 'College Level', 'Self-Employed', NULL, 'Worker', 0, NULL, NULL, 1, NULL),
(40, 44, 'Elementary Graduate', 'Self-Employed', NULL, 'Worker', 0, NULL, NULL, 1, NULL),
(41, 45, 'Vocational Graduate', 'Self-Employed', NULL, 'Out-of-School Youth', 0, NULL, NULL, 1, NULL),
(42, 46, 'Elementary Graduate', 'Wage-Employed', 'Self-Employed', 'Out-of-School Youth', 0, NULL, NULL, 1, NULL),
(43, 47, 'Vocational Graduate', 'Self-Employed', NULL, 'Out-of-School Youth', 0, NULL, NULL, 1, NULL);
...
--
ALTER TABLE `tbl_activity_logs`
  MODIFY `activity_log_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=113;
...
--
ALTER TABLE `tbl_enrolled_trainee`
  MODIFY `enrolled_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=46;
...
--
ALTER TABLE `tbl_trainee_dtl`
  MODIFY `trainee_dtl_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=44;

--
-- AUTO_INCREMENT for table `tbl_trainee_ftr`
--
ALTER TABLE `tbl_trainee_ftr`
  MODIFY `trainee_ftr_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=44;

--
-- AUTO_INCREMENT for table `tbl_trainee_hdr`
--
ALTER TABLE `tbl_trainee_hdr`
  MODIFY `trainee_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=48;
