...
(4, 'Cookery NC II - Batch 1', 4, 5, 'STEP', 3, '2026-02-17', '2026-03-13', 'open', 25),
(5, 'Shielded Metal Arc Welding (SMAW) NC II - Batch 1', 6, 6, 'TTSP', NULL, '2026-02-18', '2026-03-22', 'open', 25);
...
(5, 4, 'MWF (8:00 AM - 12:00 PM)', 'Main Room', '2026-02-15 10:16:45', '2026-02-16 06:34:36'),
(7, 5, 'Mon-Fri (8:00 AM - 12:00 PM)', 'Main Room', '2026-02-16 08:05:24', '2026-02-16 08:08:01');
...
(20, 2, 'Andrei', '$2y$10$J1lqX25qOwX/G.yLJswhs.TR2IVj45uK3Yhgol0m3JhQyfIZOjrHC', 'tayamonante@gmail.com', 'active', 0, '2026-02-15 17:38:08', NULL, NULL),
...
--
ALTER TABLE `tbl_activity_logs`
  MODIFY `activity_log_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=104;
...
--
ALTER TABLE `tbl_enrolled_trainee`
  MODIFY `enrolled_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
...
--
ALTER TABLE `tbl_offered_qualifications`
  MODIFY `offered_qualification_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `tbl_trainee_dtl`
  MODIFY `trainee_dtl_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT for table `tbl_trainee_ftr`
--
ALTER TABLE `tbl_trainee_ftr`
  MODIFY `trainee_ftr_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT for table `tbl_trainee_hdr`
--
ALTER TABLE `tbl_trainee_hdr`
  MODIFY `trainee_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
