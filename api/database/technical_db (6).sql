...
(306, 103, 'A. Installation of light fixtures and switches', 0),
(307, 103, 'B. Final testing of electrical systems', 0),
(308, 103, 'C. Installation of conduits, boxes, and wiring before wall finishing', 1),
(309, 103, 'D. Repair of damaged electrical components', 0),
(310, 104, 'A. RSC', 0),
(311, 104, 'B. IMC', 0),
(312, 104, 'C. EMT', 1),
(313, 104, 'D. PVC', 0),
...
(103, 4, 'What is meant by electrical roughing-in works?', 'multiple_choice'),
(104, 4, 'Which conduit type is known as a thin-wall steel conduit and is commonly used for indoor installations?', 'multiple_choice'),
(105, 4, 'Which conduit provides maximum mechanical protection and is commonly used in industrial areas?', 'multiple_choice'),
(106, 4, 'What type of conduit is non-metallic and resistant to corrosion?', 'multiple_choice'),
(107, 4, 'Which conduit is most suitable for underground and wet locations?', 'multiple_choice'),
(108, 4, 'EMT is commonly used for indoor residential and commercial installations.', 'true_false'),
(109, 4, 'PVC conduit provides the highest mechanical protection among all conduit types.', 'true_false'),
(110, 4, 'Roughing-in works are done after wall and ceiling finishes are completed.', 'true_false'),
(111, 4, 'Metallic conduits must be properly grounded according to PEC.', 'true_false'),
(112, 4, 'Maintaining a clean work area is part of electrical safety practices.', 'true_false');
...
--
ALTER TABLE `tbl_quiz_options`
  MODIFY `option_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=336;

--
-- AUTO_INCREMENT for table `tbl_quiz_questions`
--
ALTER TABLE `tbl_quiz_questions`
  MODIFY `question_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=113;
