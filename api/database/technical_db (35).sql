...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 17, 2026 at 04:34 AM
...
(4, 'Cookery NC II - Batch 1', 4, 5, 'TTSP', 2, '2026-02-17', '2026-03-13', 'open', 20),
...
CREATE TABLE `tbl_enrollment` (
  ...
  `status` enum('pending','qualified','unqualified','approved','rejected','completed') DEFAULT 'pending',
...
INSERT INTO `tbl_holidays` (`holiday_id`, `holiday_name`, `holiday_date`, `description`, `holiday_type`, `affected_batches`, `is_active`, `created_at`) VALUES
(1, 'Valentines Day', '2026-02-14', 'Day of Love', 'local', NULL, 1, '2026-02-14 11:26:45');
...
(5, 4, 'Night Shift (6:00 PM - 10:00 PM)', 'Main Room', '2026-02-15 10:16:45', '2026-02-16 15:06:51'),
...
(23, 2, 3, 5, '<div class=\"custom-field-block mb-3 p-3 border rounded bg-white\">\n        <div class=\"d-flex justify-content-between align-items-center mb-2\">\n            <strong contenteditable=\"true\" class=\"field-label\" style=\"cursor: text; border: 1px dashed #dee2e6; padding: 0 5px;\">Table Title</strong>\n            <div>\n                <button class=\"btn btn-sm btn-outline-primary\" onclick=\"addTableRow(\'table_1770327000323\')\" title=\"Add Row\"><i class=\"fas fa-plus\"></i> Row</button>\n                <button class=\"btn btn-sm btn-outline-primary\" onclick=\"addTableCol(\'table_1770327000323\')\" title=\"Add Column\"><i class=\"fas fa-plus\"></i> Col</button>\n                <button class=\"btn btn-sm btn-outline-info\" onclick=\"addTableCheckboxCol(\'table_1770327000323\')\" title=\"Add Checkbox Column\"><i class=\"fas fa-check-square\"></i> Checkbox</button>\n                <button class=\"btn btn-sm btn-outline-danger\" onclick=\"this.closest(\'.custom-field-block\').remove()\" title=\"Delete Table\"><i class=\"fas fa-trash\"></i></button>\n            </div>\n        </div>\n        <div class=\"table-responsive\">\n            <table class=\"table table-bordered mb-0\" id=\"table_1770327000323\" style=\"background-color: white;\">\n                <thead>\n                    <tr>\n                        <th><span contenteditable=\"true\">Header 1</span> <button contenteditable=\"false\" class=\"btn btn-xs btn-outline-danger p-0 px-1 ms-2\" onclick=\"deleteTableCol(this)\" title=\"Delete Column\">×</button></th>\n                        <th><span contenteditable=\"true\">Header 2</span> <button contenteditable=\"false\" class=\"btn btn-xs btn-outline-danger p-0 px-1 ms-2\" onclick=\"deleteTableCol(this)\" title=\"Delete Column\">×</button></th>\n                        <th style=\"text-align: center; width: 50px;\"><span contenteditable=\"true\">Check</span> <button contenteditable=\"false\" class=\"btn btn-xs btn-outline-danger p-0 px-1 ms-2\" onclick=\"deleteTableCol(this)\" title=\"Delete Column\">×</button></th><th style=\"text-align: center; width: 50px;\"><span contenteditable=\"true\">Check</span> <button contenteditable=\"false\" class=\"btn btn-xs btn-outline-danger p-0 px-1 ms-2\" onclick=\"deleteTableCol(this)\" title=\"Delete Column\">×</button></th><th class=\"table-actions-header\" style=\"width: 1%;\" contenteditable=\"false\">Actions</th>\n                    </tr>\n                </thead>\n                <tbody>\n                    <tr>\n                        <td contenteditable=\"true\"></td>\n                        <td contenteditable=\"true\"></td>\n                        <td contenteditable=\"false\" style=\"text-align: center;\"><input type=\"checkbox\" class=\"form-check-input\" style=\"cursor: pointer;\"></td><td contenteditable=\"false\" style=\"text-align: center;\"><input type=\"checkbox\" class=\"form-check-input\" style=\"cursor: pointer;\"></td><td class=\"text-center\" contenteditable=\"false\"><button class=\"btn btn-sm btn-outline-danger\" onclick=\"deleteTableRow(this)\" title=\"Delete Row\"><i class=\"fas fa-trash-alt\"></i></button></td>\n                    </tr>\n                </tbody>\n            </table>\n        </div>\n    </div>', '2026-02-09 01:02:19', NULL, NULL, NULL, NULL, 'submitted');
...
(6, 10, 'No Grade Completed', 'Unemployed', NULL, 'Student', 0, '', '', 1, 'sig_1771252735.png'),
(7, 11, 'Senior High (K-12)', 'Unemployed', NULL, 'Student', 0, '', '', 1, 'sig_1771253584.png'),
(8, 12, 'Elementary Graduate', 'Wage-Employed', 'Contractual', 'Worker', 0, NULL, NULL, 1, NULL),
(9, 13, 'College Graduate', 'Self-Employed', NULL, 'Student', 0, NULL, NULL, 1, NULL),
(10, 14, 'Elementary Graduate', 'Wage-Employed', 'Casual', 'Student', 0, NULL, NULL, 1, NULL),
(11, 15, 'High School Graduate', 'Unemployed', NULL, 'Worker', 0, NULL, NULL, 1, NULL),
(12, 16, 'Elementary Graduate', 'Unemployed', NULL, 'Worker', 0, NULL, NULL, 1, NULL),
(13, 17, 'Vocational Graduate', 'Unemployed', NULL, 'Worker', 0, NULL, NULL, 1, NULL),
(14, 18, 'Elementary Graduate', 'Self-Employed', NULL, 'Student', 1, 'Hearing Impairment', 'Illness', 1, NULL),
(15, 19, 'High School Graduate', 'Unemployed', NULL, 'Worker', 0, NULL, NULL, 1, NULL),
(16, 20, 'College Level', 'Self-Employed', NULL, 'Student', 0, NULL, NULL, 1, NULL),
(17, 21, 'Elementary Graduate', 'Self-Employed', NULL, 'Student', 0, NULL, NULL, 1, NULL),
(18, 22, 'Vocational Graduate', 'Wage-Employed', 'Contractual', 'Out-of-School Youth', 0, NULL, NULL, 1, NULL),
(19, 23, 'College Level', 'Self-Employed', NULL, 'Out-of-School Youth', 0, NULL, NULL, 1, NULL),
(20, 24, 'College Graduate', 'Unemployed', NULL, 'Out-of-School Youth', 0, NULL, NULL, 1, NULL),
(21, 25, 'College Graduate', 'Self-Employed', NULL, 'Out-of-School Youth', 1, 'Visual Impairment', 'Congenital', 1, NULL);
...
INSERT INTO `tbl_trainee_hdr` (`trainee_id`, `user_id`, `trainee_school_id`, `first_name`, `middle_name`, `last_name`, `extension_name`, `sex`, `birth_certificate_no`, `email`, `facebook_account`, `phone_number`, `address`, `ctpr_no`, `nominal_duration`, `status`, `valid_id_file`, `birth_cert_file`, `photo_file`) VALUES
(5, 12, '2-2026-0001', 'Christian Dave', 'Balamad', 'Boncales', '', 'Male', NULL, 'dawdd2523@gmail.com', 'Christian Dave Boncales', '09678715483', 'Zone 6, Baikingon, Cagayan De Oro City, Misamis Oriental', NULL, NULL, 'active', 'valid_id_1769496636_Untitled design (1).png', 'birth_1769496636_228a2415-a38e-4f27-b762-37d2ae1aec3a.png', 'photo_1769496636_64563a22-b1b4-487a-b7a0-9627907c3c5e.png'),
(7, 15, '3-2026-0003', 'Lore Lindell', 'Becoy', 'Tamayo ', '', 'Male', NULL, 'vincelerky45@gmail.com', 'Lore Tamayo', '09627641720', 'Biasong-Tinib, Macasandig, Cagayan De Oro City, Misamis Oriental', NULL, NULL, 'active', 'valid_id_1769670785_dawdaw-attack.png', 'birth_1769670785_dead0c4a-6e19-4006-96fd-0ff604520395.jfif', 'photo_1769670785_download.jfif'),
(8, 16, '2-2026-0002', 'Apple Jane', 'Memoracion', 'Edrolin', '', 'Female', NULL, 'apple@gmail.com', 'Apple Edrolin', '09987654321', 'Zone 4, Canitoan, Cagayan De Oro City, Misamis Oriental', NULL, NULL, 'active', 'valid_id_1770298422_450594508_122093386142417045_264060929535796894_n.jpg', 'birth_1770298422_Untitled diagram-2026-02-05-092208.png', 'photo_1770298422_450594508_122093386142417045_264060929535796894_n.jpg'),
(10, 25, '5-2026-0004', 'dawd', 'dad', 'dd', '', 'Female', NULL, 'ayamonante@gmail.com', 'dawdaw', '09721312331', 'Zone 5 , Tawil, Dorek, Lorcan', NULL, NULL, 'active', 'valid_id_1771252735_tesda1.jfif', 'birth_1771252735_tesda1.jfif', 'photo_1771252735_ChatGPT Image Jan 30, 2026, 06_38_44 PM.png'),
(11, 26, '4-2026-0005', 'Loren', 'Brig', 'Gaso', '', 'Female', NULL, 'tayamonante@gmail.com', 'LorenGas', '09832133213', 'Zone 4, Tibasak, Kwary, Bukidnon', NULL, NULL, 'active', 'valid_id_1771253584_tesda.jfif', 'birth_1771253584_tesda_logo_transparent.png', 'photo_1771253584_e08f66db-9d9b-422f-85d7-b81bcd21d383.jfif'),
(12, NULL, '5-2026-0006', 'Angela', 'F.', 'Garcia', '', 'Female', 'BC756280281', 'angela.garcia@example.com', 'facebook_angela', '09433866075', '907 Street, Barangay Mabini, Davao City, Davao del Sur', 'CTPR236919', NULL, 'active', NULL, NULL, NULL),
(13, NULL, '5-2026-0007', 'Antonio', 'G.', 'Castro', '', 'Male', 'BC211935230', 'antonio.castro@example.com', 'facebook_antonio', '09909157774', '874 Road, Barangay Lahug, Cebu City, Cebu', 'CTPR507708', NULL, 'active', NULL, NULL, NULL),
(14, NULL, '5-2026-0008', 'Joshua', 'Mendoza', 'Aquino', '', 'Male', 'BC540011935', 'joshua.aquino@example.com', 'facebook_joshua', '09258692102', '225 Drive, Barangay Talomo, Davao City, Davao del Sur', 'CTPR800351', NULL, 'active', NULL, NULL, NULL),
(15, NULL, '5-2026-0009', 'Ricardo', 'S.', 'Flores', '', 'Male', 'BC102635580', 'ricardo.flores@example.com', 'facebook_ricardo', '09964039892', '493 Block, Barangay Kapitolyo, Pasig City, Metro Manila', 'CTPR630377', NULL, 'active', NULL, NULL, NULL),
(16, NULL, '5-2026-0010', 'Nicole', 'T.', 'Gonzales', '', 'Female', 'BC342882992', 'nicole.gonzales@example.com', 'facebook_nicole', '09866347321', '713 Street, Barangay Maligaya, Pasig City, Metro Manila', 'CTPR944234', NULL, 'active', NULL, NULL, NULL),
(17, NULL, '5-2026-0011', 'Christian', 'Gonzales', 'Cruz', '', 'Male', 'BC511645179', 'christian.cruz@example.com', 'facebook_christian', '09352761921', '120 Road, Barangay Guadalupe, Cebu City, Cebu', 'CTPR579095', NULL, 'active', NULL, NULL, NULL),
(18, NULL, '5-2026-0012', 'Daniel', 'R.', 'Soriano', '', 'Male', 'BC617738166', 'daniel.soriano@example.com', 'facebook_daniel', '09938354858', '398 Drive, Barangay Kapitolyo, Pasig City, Metro Manila', 'CTPR616438', NULL, 'active', NULL, NULL, NULL),
(19, NULL, '5-2026-0013', 'Elena', 'Torres', 'Aquino', '', 'Female', 'BC914488690', 'elena.aquino@example.com', 'facebook_elena', '09630328953', '722 Block, Barangay Ugong, Pasig City, Metro Manila', 'CTPR629477', NULL, 'active', NULL, NULL, NULL),
(20, NULL, '5-2026-0014', 'Rosa', 'F.', 'Flores', '', 'Female', 'BC606365363', 'rosa.flores@example.com', 'facebook_rosa', '09712602367', '92 Avenue, Barangay Buhangin, Davao City, Davao del Sur', 'CTPR356510', NULL, 'active', NULL, NULL, NULL),
(21, NULL, '5-2026-0015', 'Daniel', 'Mendoza', 'Aquino', '', 'Male', 'BC620986189', 'daniel.aquino@example.com', 'facebook_daniel', '09160012078', '355 Street, Barangay Talomo, Davao City, Davao del Sur', 'CTPR140737', NULL, 'active', NULL, NULL, NULL),
(22, NULL, '5-2026-0016', 'Angelo', 'Reyes', 'Pascual', '', 'Male', 'BC876863902', 'angelo.pascual@example.com', 'facebook_angelo', '09410125151', '697 Road, Barangay San Isidro, Quezon City, Metro Manila', 'CTPR124231', NULL, 'active', NULL, NULL, NULL),
(23, NULL, '5-2026-0017', 'Isabella', 'S.', 'Torres', '', 'Female', 'BC319252208', 'isabella.torres@example.com', 'facebook_isabella', '09751226120', '399 Drive, Barangay Commonwealth, Quezon City, Metro Manila', 'CTPR524460', NULL, 'active', NULL, NULL, NULL),
(24, NULL, '5-2026-0018', 'Catherine', 'Flores', 'Pascual', '', 'Female', 'BC657475593', 'catherine.pascual@example.com', 'facebook_catherine', '09294876080', '867 Street, Barangay Talomo, Davao City, Davao del Sur', 'CTPR302774', NULL, 'active', NULL, NULL, NULL),
(25, NULL, '5-2026-0019', 'Ramon', 'Ramos', 'Castro', '', 'Male', 'BC444386908', 'ramon.castro@example.com', 'facebook_ramon', '09948643369', '672 Avenue, Barangay San Roque, Caloocan City, Metro Manila', 'CTPR627198', NULL, 'active', NULL, NULL, NULL);
...
(5, 20, 'Andrei', 'Davinci', 'tayamonante@gmail.com', '09798741828', 4, 'dadv', '123234', 'nttc_file_20_1771148288.jpg', 'tm_file_20_1771148288.jpg', 'NC II', 'nc_file_20_1771148288.jpg', 'experience_file_20_1771148288.jpg', 'active'),
...
(17, 4, 'Dodo', '$2y$10$b0/nxH4TeJXz9t/9ahYro.jGI4ZnNaIjUQkfw.ZXgXDR4mywCCmUK', 'dodo@gmail.com', 'active', 0, '2026-02-14 19:29:36', NULL, NULL),
...
(25, 3, 'dd', '$2y$10$Tn5wvesDXWRoTY7wr4Ml6eU/dWKHjVBG2ftec473RKXqpFCypS89G', 'tayamonante@gmail.com', 'active', 0, '2026-02-16 23:00:31', NULL, NULL),
...
--
ALTER TABLE `tbl_activity_logs`
  MODIFY `activity_log_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=109;
...
--
ALTER TABLE `tbl_enrolled_trainee`
  MODIFY `enrolled_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=25;
...
--
ALTER TABLE `tbl_offered_qualifications`
  MODIFY `offered_qualification_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
ALTER TABLE `tbl_qualifications`
  MODIFY `qualification_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
ALTER TABLE `tbl_trainee_dtl`
  MODIFY `trainee_dtl_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;

--
-- AUTO_INCREMENT for table `tbl_trainee_ftr`
--
ALTER TABLE `tbl_trainee_ftr`
  MODIFY `trainee_ftr_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;

--
-- AUTO_INCREMENT for table `tbl_trainee_hdr`
--
ALTER TABLE `tbl_trainee_hdr`
  MODIFY `trainee_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=26;
