...
INSERT INTO `tbl_grades` (`grade_id`, `trainee_id`, `course_id`, `test_id`, `score`, `remarks`, `date_recorded`) VALUES
...
(2, 3, NULL, 'LEARNING OUTCOME 1: PLAN AND PREPARE WORK', '', '2026-02-05 18:48:00', 'task_1769617613_598706627_3335430083274662_7994946475721277614_n (1).png', NULL),
...
(4, 2, 1, NULL, 100.00, '2026-02-05 00:00:00');
...
--
ALTER TABLE `tbl_grades`
  ADD CONSTRAINT `fk_grades_course` FOREIGN KEY (`course_id`) REFERENCES `tbl_course` (`course_id`) ON DELETE CASCADE ON UPDATE CASCADE,
