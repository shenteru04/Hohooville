...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 15, 2026 at 11:36 AM
...
(4, 'Cookery NC II - Batch 1', 4, 5, 'STEP', NULL, '2026-02-17', '2026-03-13', 'open');
...
(5, 4, 'MWF (8:00 AM - 12:00 PM)', 'Main Room', '2026-02-15 10:16:45', '2026-02-15 10:16:45');
...
(1, 1, 'admin', '$2y$10$E/bu7wq4cpXXZz0Vu3vEYObwc.cMpdGpU3JvMbZBvOiD8D6qtLybG', 'christiandaveboncales@gmail.com', 'active', '2025-12-22 11:20:13'),
(10, 2, 'Juan', '$2y$10$pVNvO.T.Ealmtuc6buthQO8/Vy1IRUKqKcpNXwWkgTYus4EM3Obuu', 'christianboncales09@gmail.com', 'active', '2026-01-11 19:21:40'),
(12, 3, 'christian', '$2y$10$sBKhB8oyhEK/aQCsjOJ9sOkWRgLdNO5wXG9qaq44I3FuBpHAsIxby', 'dawdd2523@gmail.com', 'active', '2026-01-27 23:41:57'),
...
(17, 4, 'Dodo', '$2y$10$b0/nxH4TeJXz9t/9ahYro.jGI4ZnNaIjUQkfw.ZXgXDR4mywCCmUK', 'dodo@gmail.com', 'active', '2026-02-14 19:29:36'),
(20, 2, 'Andrei', '$2y$10$J1lqX25qOwX/G.yLJswhs.TR2IVj45uK3Yhgol0m3JhQyfIZOjrHC', 'tayamonante@gmail.com', 'active', '2026-02-15 17:38:08');
...
--
ALTER TABLE `tbl_activity_logs`
  MODIFY `activity_log_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=88;
...
--
ALTER TABLE `tbl_offered_qualifications`
  MODIFY `offered_qualification_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
